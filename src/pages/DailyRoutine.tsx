...
const DAILY_PROMPTS_ES = [
  ...
  "Nombra una cosa buena que te ha pasado aquí en tu nuevo país.",
  ...
  "¿Cuál es tu mayor logro desde que llegaste a tu nuevo país?",
...
const DAILY_PROMPTS_EN = [
  ...
  "Name one good thing that happened to you here in the your new country.",
  ...
  "What's your biggest achievement since arriving in the your new country?",
